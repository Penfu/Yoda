<div class="py-4">
    @isset($lastupdate)
        <div class="pb-12">
            ...
            <input wire:model="lastupdate" name="updated-limit" type="number" min="1" max="1000"
                value="{{ $lastupdate }}" class="w-24 h-8 rounded"></input>
            <span class="">{{ $lastupdate == 1 ? 'jour' : 'jours' }}</span>
        </div>
    @endisset
